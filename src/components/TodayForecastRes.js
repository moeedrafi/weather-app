...
import { Box, Divider, SvgIcon, Typography, Grid, AppBar, Button } from "@mui/material";
import {
...
const TodayForecastRes = ({ weather, toggleSearch }) => {
        ...
        >
          <Box m="20px">
            ...
            <Box m={1} display="flex">
              <Box width="100%" backgroundColor="#131214" borderRadius="16px">
                <Typography
                  m={1}
                  variant="h6"
                  fontFamily="Satoshi"
...
export default TodayForecastRes;
