      ...
      {/* <Box
        ...
        >
          <Box m="15px">
            ...
            <Grid container spacing={5} alignItems="center">
              <Grid mt={1} item>
                <CloudIcon sx={{ width: "30px", height: "30px" }} />
              </Grid>
              <Grid item>
                <Typography variant="body-1" fontFamily="Satoshi">
                  5&deg;C
        ...
        >
          ...
          {/* sunset and sunrise, humidity etc */}
          <Box
          m={1}
          sx={{ display: { xs: "grid", sm: "none" } }}
          gridTemplateColumns="repeat(12, 1fr)"
        ...
        >
          <Box
            ...
            borderRadius="16px"
          >
            <Typography m={1} variant="h6" fontFamily="Satoshi" color="#7b7980">
              Sunrise and Sunset
            </Typography>
            <Box
              display="grid"
            ...
            >
              ...
              <Box
                ...
                alignItems="center"
              >
                <WbSunnyOutlinedIcon sx={{ width: "40px", height: "40px" }} />
                <Box
                  display="flex"
                  alignItems="center"
              ...
              <Box
                ...
                alignItems="center"
              >
                <DarkModeOutlinedIcon sx={{ width: "40px", height: "40px" }} />
                <Box
                  display="flex"
                  alignItems="center"
                  flexDirection="column"
          ...
          <Box
            ...
            backgroundColor="#131214"
          >
            <Typography m={2} variant="h6" fontFamily="Satoshi" color="#7b7980">
              Humidity
            </Typography>
            <Box m="20px" display="flex" alignItems="center">
              <SvgIcon sx={{ mr: "auto", width: "40px", height: "40px" }}>
          ...
          >
            ...
            <Box m="20px" display="flex" alignItems="center">
              <VisibilityOutlinedIcon
                sx={{ mr: "auto", width: "40px", height: "40px" }}
              />
              <Typography variant="h6" fontFamily="Satoshi">
                10km
              </Typography>
